...
for i in range(len(data_list)):
    ...
    for j in range(len(binID_rcount_list)):
        ...
        graphics.PartitionBoxplot (binID_rcount, data, frac, xlabel="", ylabel='Normalized Counts', title = data_name[i] + " Titration " + str(j+1), note=fname + "_" + data_name[i] + "_" + str(j+1))
