...
for chr_choice in chr_choices:
    ...
    field_ID_value = load_file.read_tabular_file ("H1_DNA_sp_10kb_anot.cn", mode='col')
    ...
    target_names = ["H1-DNA-sp-3.bam"]
    names = ["H2AZ", "H3k27ac", "H3k27me3", "H3k36me3", "H3k4me1", "H3k4me3", "H3k9ac", "H3k9me3"]
    cmap_list = ['rainbow']
