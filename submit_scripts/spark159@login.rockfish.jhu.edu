...
if False:
    for exp in exps:
        ...
        for bin_size in bin_sizes:
            ...
            input_fname = output_path + '/' + input_fheader  + '_' + str(int(bin_size/1000)) + 'kb' + '_num.cn'
        ...
        if ID_deep != '':
            ...
            chr_names = cell_chrnames[cell]
            for chr_name in chr_names:
                fname = output_path + '/' + fheader + '_' + chr_name + '_num.cn'
                fnames.append(fname)
                input_fname = output_path + '/' + input_fheader + '_' + chr_name + '_num.cn'
