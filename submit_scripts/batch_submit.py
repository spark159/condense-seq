...
inpath = "/home/spark159/scratch4-tha4/sangwoo/2022_09_08_GM_sp_H1_HP1a_deep/"
outpath = "/home/spark159/scratch4-tha4/sangwoo/2022_09_08_GM_sp_H1_HP1a_deep/"
refname = outpath + "hg38"
...
for cell in cell_sample_agent_tnum_fname:
    for sample in cell_sample_agent_tnum_fname[cell]:
        ...
        for agent in agent_tnum_fname:
            ...
            #subprocess.call(["sbatch", "binannot_submit", "-f", newcn, "-x", refname+'.fa', "-w", str(bin_width), "-s", str(bin_step), "-o", outfname, "-b", '', "-c", ''])
