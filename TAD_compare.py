...
box_data = [[ID_score1[ID] for ID in OutTAD_IDs], [ID_score1[ID] for ID in InTAD_IDs]]
fig = plt.figure()
...
for fname in fnames:
    ...
    box_data = [[ID_score1[ID] for ID in A_IDs], [ID_score1[ID] for ID in B_IDs]]
